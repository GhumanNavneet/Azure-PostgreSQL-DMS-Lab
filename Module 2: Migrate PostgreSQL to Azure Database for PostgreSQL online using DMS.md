...
2. Inside the virtual machine open **command prompt** from **start** button, run it as **adminstrator** and change the directory to **C:\Program Files\PostgreSQL\9.6\bin** using following command:
```
